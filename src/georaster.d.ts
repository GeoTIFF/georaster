...
/**
 * Creates a Georaster by parsing in-memory data arrays and accompanying metadata.  The first data dimension is raster band.
 * The second and third dimension are the 2D grid of cell values.
 */
