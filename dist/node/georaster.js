...
var geotiffPalette = require('geotiff-palette');
var toCanvas = require('georaster-to-canvas');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var toCanvas__default = /*#__PURE__*/_interopDefaultLegacy(toCanvas);
  ...
  preinitialize(debug) {
    ...
    if (this._url) {
      ...
      return urlExists(ovrURL).then(ovrExists => {
        ...
        if (ovrExists) {
          return geotiff.fromUrls(this._url, [ovrURL], {cache: true, forceXHR: false});
        } else {
          return geotiff.fromUrl(this._url, {cache: true, forceXHR: false});
        }
      });
    } else {
          ...
          if (this._web_worker_is_available) {
            ...
            worker.onmessage = (e) => {
              ...
              this.toCanvas = function(options) {
                return toCanvas__default["default"](this, options);
              };
              resolve(this);
            };
